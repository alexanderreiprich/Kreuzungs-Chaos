namespace KreuzungsChaos {
    ...
    export class Street {
        ...
        public stop: fc.Vector3;

        public constructor(_id: string, _startInt: fc.Vector3, _endInt: fc.Vector3, _startAway: fc.Vector3, _endAway: fc.Vector3, _stop: fc.Vector3) {
